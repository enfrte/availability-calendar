...
-- la 26. toukokuuta 2018 00.25.59
...
CREATE TABLE IF NOT EXISTS `availability_calendar`.`positions` (
  ...
  `max_vol` MEDIUMINT UNSIGNED NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `availability_calendar`.`requirements`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `availability_calendar`.`requirements` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(45) NOT NULL,
  `description` TEXT NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'The visibility of certain projects to certain users. ';


-- -----------------------------------------------------
-- Table `availability_calendar`.`users_requirements`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `availability_calendar`.`users_requirements` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `users_id` INT(11) UNSIGNED NOT NULL,
  `requirements_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_users_requirements_users1_idx` (`users_id` ASC),
  INDEX `fk_users_requirements_requirements1_idx` (`requirements_id` ASC),
  UNIQUE INDEX `uc_users_requirements` (`users_id` ASC, `requirements_id` ASC),
  CONSTRAINT `fk_users_requirements_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `availability_calendar`.`users` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_requirements_requirements1`
    FOREIGN KEY (`requirements_id`)
    REFERENCES `availability_calendar`.`requirements` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `availability_calendar`.`projects_requirements`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `availability_calendar`.`projects_requirements` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `projects_id` INT UNSIGNED NOT NULL,
  `requirements_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_projects_requirements_requirements1_idx` (`requirements_id` ASC),
  INDEX `fk_projects_requirements_projects1_idx` (`projects_id` ASC),
  CONSTRAINT `fk_projects_requirements_requirements1`
    FOREIGN KEY (`requirements_id`)
    REFERENCES `availability_calendar`.`requirements` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_projects_requirements_projects1`
