 ...
 */
$config['site_title']                 = "Example Title";       // Site Title, example.com
$config['admin_email']                = "example@example.com"; // Admin Email, admin@example.com
...
$config['manual_activation']          = FALSE;               // Manual Activation for registration (by admin, I assume)
